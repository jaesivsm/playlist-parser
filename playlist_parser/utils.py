...
class XmlParser(object):
	...
	def __init__(self, xml_file=None):
		...
		self.__parser.StartElementHandler = self._parsing_start_element
		self.__parser.EndElementHandler = self._parsing_end_element
		self.__parser.CharacterDataHandler = self._parsing_char_data
	...
	def _parsing_start_element(self, tag, attrs):
		self.previous_tag.append(self.current_tag)
	...
	def _parsing_char_data(self, data):
		return self.parsing_char_data(data)

	def parsing_char_data(self, data):
		raise NotImplementedError()

	def _parsing_end_element(self, tag):
		self.current_tag = self.previous_tag.pop()
